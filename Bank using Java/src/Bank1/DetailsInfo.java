package Bank1;
import Bank1.AccountShow;
import Bank1.CustomerDetails;
import Bank1.LoginPage;
import Bank1.MoneyTransfer1;
import static Bank1.MoneyTransfer1.Amount;
import Bank1.WelcomePage;
import java.sql.*;
...
public class DetailsInfo extends javax.swing.JFrame {
    ...
    private void jButtonMoneytransferActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMoneytransferActionPerformed
        ...
        try {
            ...
            Logger.getLogger(DetailsInfo.class.getName()).log(Level.SEVERE, null, ex);
        }
        mf.pack();
 ...
 public javax.swing.JButton getjButtonAccount1ActionPerformed()
    {
        return jButtonPersonal;
    }
    ...
    {
        return jButtonAccount1;
    }
      public JButton getJButton3()
    {
        return jButtonMoneytransfer;
    }
