...
public class MoneyTransfer1 extends javax.swing.JFrame {
 ...
 public static int   Amount=0;
    ...
    private void initComponents() {
        ...
        jTextFieldBeneficiaryAccountNo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldBeneficiaryAccountNoActionPerformed(evt);
            }
        });
    ...
    private void jLabelAccount1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelAccount1MouseClicked
        ...
        this.dispose();
            ...
            Logger.getLogger(MoneyTransfer1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButtonProceedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonProceedActionPerformed
        int Account_no=0,BenificiaryAccount_No=0;
         ...
         try
        {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/Bank2","root","abc123");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
                {
                    Connection mycon=DriverManager.getConnection("jdbc:mysql://localhost:3306/Bank2?autoReconnect=true","root","abc123");
                    String s1="";
    ...
    private void jTextFieldBeneficiaryAccountNoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldBeneficiaryAccountNoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldBeneficiaryAccountNoActionPerformed
  ...
  public void setJtextField1(String Bacno){

    jTextFieldBeneficiaryAccountNo.setText(Bacno);
       
}
  public void setJtextField2(String actype){

 jTextFieldBeneficiaryAccountType.setText(actype);
} 
  public void setJtextField3(String am){

 jTextFieldAmount.setText(am);
}
  public JTextField getJtextField1(){

return jTextFieldBeneficiaryAccountNo;
}
  public JTextField getJtextField2(){

return jTextFieldBeneficiaryAccountType;
} 
  public JTextField getJtextField3(){

return jTextFieldAmount;
}
  public JButton getJbuttonProceed(){
